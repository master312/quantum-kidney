...
${OBJECTDIR}/src/game/ingame/entities/cEntityManager.o: src/game/ingame/entities/cEntityManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/game/ingame/entities
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/game/ingame/entities/cEntityManager.o src/game/ingame/entities/cEntityManager.cpp
...
${OBJECTDIR}/src/game/ingame/entities/components/cComPawn.o: src/game/ingame/entities/components/cComPawn.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/game/ingame/entities/components
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/game/ingame/entities/components/cComPawn.o src/game/ingame/entities/components/cComPawn.cpp
...
${OBJECTDIR}/src/game/ingame/entities/systems/cSysAnimation.o: src/game/ingame/entities/systems/cSysAnimation.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/game/ingame/entities/systems/cSysAnimation.o src/game/ingame/entities/systems/cSysAnimation.cpp

${OBJECTDIR}/src/game/ingame/entities/systems/cSysCollision.o: src/game/ingame/entities/systems/cSysCollision.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/game/ingame/entities/systems
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/game/ingame/entities/systems/cSysCollision.o src/game/ingame/entities/systems/cSysCollision.cpp

${OBJECTDIR}/src/game/ingame/entities/systems/cSysImage.o: src/game/ingame/entities/systems/cSysImage.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/game/ingame/entities/systems
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/game/ingame/entities/systems/cSysImage.o src/game/ingame/entities/systems/cSysImage.cpp

${OBJECTDIR}/src/game/ingame/entities/systems/cSysPlayerDriver.o: src/game/ingame/entities/systems/cSysPlayerDriver.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/game/ingame/entities/systems
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/game/ingame/entities/systems/cSysPlayerDriver.o src/game/ingame/entities/systems/cSysPlayerDriver.cpp
...
${OBJECTDIR}/src/game/ingame/map/cDebgMapEditor.o: src/game/ingame/map/cDebgMapEditor.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/game/ingame/map/cDebgMapEditor.o src/game/ingame/map/cDebgMapEditor.cpp
