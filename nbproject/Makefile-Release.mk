...
${OBJECTDIR}/src/game/entities/cCharacter.o: src/game/entities/cCharacter.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/game/entities/cCharacter.o src/game/entities/cCharacter.cpp

${OBJECTDIR}/src/game/entities/cEntity.o: src/game/entities/cEntity.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/game/entities
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/game/entities/cEntity.o src/game/entities/cEntity.cpp

${OBJECTDIR}/src/game/entities/cNpc.o: src/game/entities/cNpc.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/game/entities
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/game/entities/cNpc.o src/game/entities/cNpc.cpp

${OBJECTDIR}/src/game/entities/cObject.o: src/game/entities/cObject.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/game/entities
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/game/entities/cObject.o src/game/entities/cObject.cpp

${OBJECTDIR}/src/game/entities/cPawn.o: src/game/entities/cPawn.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/game/entities
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/game/entities/cPawn.o src/game/entities/cPawn.cpp
